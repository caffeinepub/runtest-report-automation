...
export interface ColumnMappingState {
  ...
  getColumnValue: (rawRow: Record<string, string> | undefined, col: string) => string;
}
...
export function useColumnMapping(): ColumnMappingState {
  ...
  return { selectedColumns, toggleColumn, selectAll, clearAll, isSelected, getColumnValue };
}
