    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <Tabs defaultValue="import">
        <TabsList className="bg-muted/40 border border-border/30">
          <TabsTrigger value="import" className="text-xs data-[state=active]:bg-amber-500 data-[state=active]:text-navy-950">
            <Upload className="h-3 w-3 mr-1" />
            File Import
          </TabsTrigger>
          <TabsTrigger value="manual" className="text-xs data-[state=active]:bg-amber-500 data-[state=active]:text-navy-950">
            ...
            <CardContent className="pt-4 pb-4">
              <div className="flex gap-3">
                ...
                <div className="space-y-1">
                  <p className="text-xs font-medium text-amber-300">Custom Column Mapping</p>
                  <p className="text-xs text-muted-foreground">
                    After uploading a file, expand the <strong className="text-amber-400">Custom Column Mapping</strong> section
                    to select which CSV/XLS fields (e.g. Temperature, Battery, Latitude) should appear as
                    additional columns in the Dashboard and Reports table. Your selection is saved automatically.
                  </p>
                </div>
              </div>
            </CardContent>
